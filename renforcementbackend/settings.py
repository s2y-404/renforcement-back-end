"""
Django settings for renforcementbackend project.
...
SECRET_KEY = 'django-insecure-vt_(*ea^tg1)9b8h2xrs+4v+(jnr8u&(3r5ulyi3gvi&z(n((='
...
ROOT_URLCONF = 'renforcementbackend.urls'
...
WSGI_APPLICATION = 'renforcementbackend.wsgi.application'
